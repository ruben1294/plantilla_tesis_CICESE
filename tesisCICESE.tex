...
%\usepackage{arev}
%uso de funte por defecto de LaTeX para las ecuaciones
...
%\makeglossaries %habilitar para glosarios
...
%  {\normalfont\huge\bfseries}{\chaptertitlename\ \thechapter}{16pt}{\Huge}
  ...
  \titleformat{\chapter} % command
	[hang] % shape
	{\fontsize{16.5pt}{10}\bfseries} % format
...
%para editar el espacio de subtitulos y titulos
%\titlespacing{command}{left spacing}{before spacing}{after spacing}[right]
\titlespacing\chapter{0pt}{-40.25pt plus 1pt minus 2pt}{12pt plus 2pt minus 0pt}
\titlespacing\section{0pt}{36pt plus 0pt minus 0pt}{18pt plus 0pt minus 2pt}
\titlespacing\subsection{0pt}{36pt plus 0pt minus 0pt}{18pt plus 0pt minus 0pt}
\titlespacing\subsubsection{0pt}{36pt plus 0pt minus 0pt}{18pt plus 0pt minus 0pt}
...
% para editar los espacios entre texto y figuras/tablas/ecuaciones, figuras/tablas/ecuaciones y figuras/tablas/ecuaciones
\setlength{\textfloatsep}{18pt plus 1.0pt minus 1.0pt} %modifica espacio entre figuras/figuras, figuras/ecuaciones, figuras/tablas
\setlength{\intextsep}{18pt plus 1.0pt minus 1.0pt} %modifica espacio del texto después de una figura, ecuación o tabla
%\setlength{\floatsep}{36pt plus 1.0pt minus 2.0pt}

%\newcommand{\squeezeup}{\vspace{5mm}} %para reducir a aumentar espacios en lugares específicos para usar añadir \squeezeup en el lugar deseado
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\anioDefensa{a\~no de defensa}

% Nombre de tu director de tesis, si tienes codirector repite el comando
\director{Dr./Dra. Xxxx Xxxx Xxxx}
\titulodirector{Directora de tesis}
%\titulocodirectoruno{Codirector de tesis}

%\director{Dr./Dra. Xxxx Xxxx Xxxx}
%\titulocodirectordos{Codirector de tesis}

% Nombre de tu director de tesis en inglés, si tienes codirector repite el comando
\directorIN{PhD Xxxx Xxxx Xxxx}
%\directorIN{PhD Xxxx Xxxx Xxxx}
...
\dirposgrado{Dra. Ana Denise Re Araujo}
...
% 2026/05/02: El comando \nocite{*} es para que todas las referencias contenidas en el archivo "export.bib", se incluyan en la sección de "Literatura citada". Sin este comando, sólo se incluyen aquellas referencias que realmente se citan en el documento, lo que nos da una lista más limpia y compacta.
%\nocite{*}
